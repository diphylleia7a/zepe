/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config dist/server/wrangler.json worker-configuration.d.ts --env-interface CloudflareEnv` (hash: 345193746db4550a802ca4119142faff)
